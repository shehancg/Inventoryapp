...
namespace Inventoryapp.mainforms
{
    public partial class productlist : Form
    {
        ...
        public void filldrpdwn()
        {
            ...
            {
                bunifuDropdown1.Items.Add(dr["units"].ToString());
            }
        }
        private void bunifuButton1_Click(object sender, EventArgs e)
        {
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "insert into products values('"+ bunifuTextBox1.Text +"','"+ bunifuDropdown1.SelectedItem.ToString() +"')";
            cmd.ExecuteNonQuery();
            bunifuTextBox1.Text = "";
            filldatagrid();
            filldrpdwn();
        ...
        private void bunifuButton3_Click(object sender, EventArgs e)
        {
            ...
            cmd1.CommandText = "select * from units where units='" + bunifuTextBox2.Text + "'";
            ...
            if (count == 0)
            {
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "insert into units values('" + bunifuTextBox2.Text + "')";
                cmd.ExecuteNonQuery();
